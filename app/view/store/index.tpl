            ...
            <div class="card-body">
                <div class="media">
                    ...
                    <div class="p-2 bg-cyan white media-body">
                        <h5>Managers</h5>
                        <h5 class="text-bold-400">{count($manager)}</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="media">
                    ...
                    <div class="p-2 bg-deep-orange white media-body">
                        <h5>Stores</h5>
                        <h5 class="text-bold-400">{count($store)}</h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="media">
                    ...
                    <div class="p-2 bg-teal white media-body">
                        <h5>Products</h5>
                        <h5 class="text-bold-400">{count($product)}</h5>
                    </div>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-xl-8 col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-block">
                    <p class="m-0">Total Products:{count($product)}<span class="float-xs-right"><a href="#" target="_blank">See All <i class="icon-arrow-right2"></i></a></span></p>
                </div>
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                        {for $i=0 to count($product)-1}
                            <tr><!-- portrait/small/avatar-s-4 -->
                                <td class="text-truncate">{$product[$i]->title}</td>
                                <td class="text-truncate">
                                    <span class="avatar avatar-xs"><img src="/src/app-assets/images/logo/ms.png" alt="avatar"></span> <span>{$product[$i]->category}</span>
                                </td>
                                <td class="text-truncate"><span class="tag tag-success">@ {$product[$i]->city}</span></td>
                           ...
                           <!--  <tr>
                                ...
                                <td class="text-truncate">
                                    <span class="avatar avatar-xs"><img src="/src/app-assets/images/portrait/small/avatar-s-5.png" alt="avatar"></span> <span>Edward C.</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-truncate">
                                    <span class="avatar avatar-xs"><img src="/src/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"></span> <span>Carol E.</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-truncate">
                                    <span class="avatar avatar-xs"><img src="/src/app-assets/images/portrait/small/avatar-s-7.png" alt="avatar"></span> <span>Gregory L.</span>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="text-truncate">
                                    <span class="avatar avatar-xs"><img src="/src/app-assets/images/portrait/small/avatar-s-8.png" alt="avatar"></span> <span>Susan S.</span>
                                </td>
                                <td class="text-truncate"><span class="tag tag-warning">Medium</span></td>
                                <td class="valign-middle">
                            ...
                            <tr>
                                ...
                                <td class="text-truncate">
                                    <span class="avatar avatar-xs"><img src="/src/app-assets/images/portrait/small/avatar-s-9.png" alt="avatar"></span> <span>Walter K.</span>
                                </td>
                                <td class="text-truncate"><span class="tag tag-danger">Critical</span></td>
                                <td class="valign-middle">
                ...
                <div class="card-block">
                    <div class="media">
                        ...
                        <div class="media-body white text-xs-right">
                            <h3>278</h3>
                            <a href="/store/registerstore"> <span>Create Stores</span> </a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-block">
                    <div class="media">
                        <div class="media-body white text-xs-left">
                            <h3>156</h3>
                            <a href="/seller/registermanager"><span>Add Managers</span> </a>
                        </div>
            ...
            <div class="card-body">
                <div class="card-block">
                    <div class="media">
                        ...
                        <div class="media-body white text-xs-right">
                            <h3>156</h3>
                            <a href="/product/view"> <span>Add Product</span></a>
                        </div>
                    </div>
                </div>
            </div>
